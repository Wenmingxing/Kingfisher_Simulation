...
void Quaternion_CallBack(const nav_msgs::Odometry::ConstPtr msg)
{
...
{
	ros::init(argc,argv,"q_rpy");
	ros::NodeHandle n;
	rpy_publisher = n.advertise<geometry_msgs::Vector3>("rpy",1000);
	quaternion_subscriber = n.subscribe("odometry/filtered/global",1000,Quaternion_CallBack);
